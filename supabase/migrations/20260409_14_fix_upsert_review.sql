-- Drop and recreate upsert_review with correct daily_activity column names

DROP FUNCTION IF EXISTS upsert_review(UUID, UUID, BOOLEAN, INT);
...
BEGIN
  ...
  ON CONFLICT (user_id, activity_date) DO UPDATE
    SET sessions_completed = daily_activity.sessions_completed + 1;
END;
$$ LANGUAGE plpgsql;
